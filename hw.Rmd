...
| Homework 2                     |               Data Programming in R |
| :---                           |                                ---: |
| Due by 11:59 PM on Wed Sep 7   | Business Analytics Graduate Program |
...
Subset the data frame to keep only records with latitude measurements
...
calendar order, i.e., "Jan", "Feb", ..., "Dec".
...
`CaloriesPerc` and then increasing order of `Protein`.
